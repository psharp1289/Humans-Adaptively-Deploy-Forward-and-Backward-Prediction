...
subs_csv=[['sub','PR Evidence','bias_highbaserate','pre_map_change','post_map_change','rt_planning_pr','high_br','low_br']]
...
with open('all_planning_questions_baseratebias_withlowhighbaserates.csv','w') as f:
	writer=csv.writer(f)
