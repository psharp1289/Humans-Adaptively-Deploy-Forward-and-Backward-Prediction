...
'3':['successorRepresentation',1],
'4':['successorRepresentation',2],
'7':['baseratebias',6],
'8':['baseratebias',5],
'9':['baseratebias',6],
'10':['baseratebias',5],
...
'8':['ASpredictive_representation_test_premap',5],
'9':['ASpredictive_representation_test_premap',6],
...
tr_dict={
'11':['predictive_representation_test_postmap',6],
'12':['predictive_representation_test_postmap',1],
'13':['predictive_representation_test_postmap',2],
'14':['predictive_representation_test_postmap',5]
...
subs_csv=[['sub','SR Evidence','bias_highbaserate','pre_map_change','post_map_change','twostep_planning']]
...
for df in sub_dfs:
	...
	current_row=[sub_names[sub_num],evidence_successorRepresentation/4.0,base_rate_high/4.0,rr_score/4.0,tr_score/4.0,twostep_planning_score/4.0]
