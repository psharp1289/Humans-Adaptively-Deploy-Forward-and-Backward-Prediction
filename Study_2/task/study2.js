...
let expName = 'study2';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'Study2_learningtrials_r3.csv', 'path': 'Study2_learningtrials_r3.csv'},
...
function trialsLoopBegin(trialsLoopScheduler) {
  ...
  trials = new TrialHandler({
    ...
    extraInfo: expInfo, originPath: undefined,
    trialList: 'Study2_learningtrials_r3.csv',
...
function stage1RoutineEachFrame(snapshot) {
  return function () {
    ...
    frameRemains = 0.0 + 7 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (planet_start_learning.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      planet_start_learning.setAutoDraw(false);
    }
