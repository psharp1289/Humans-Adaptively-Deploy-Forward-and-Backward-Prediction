...
let expName = 'pr_task_fullstudy1';  // from the Builder filename that created this script
...
const PRG_vs_GuessingLoopScheduler = new Scheduler(psychoJS);
flowScheduler.add(PRG_vs_GuessingLoopBegin, PRG_vs_GuessingLoopScheduler);
flowScheduler.add(PRG_vs_GuessingLoopScheduler);
flowScheduler.add(PRG_vs_GuessingLoopEnd);
const reward_reval_realLoopScheduler = new Scheduler(psychoJS);
flowScheduler.add(reward_reval_realLoopBegin, reward_reval_realLoopScheduler);
flowScheduler.add(reward_reval_realLoopScheduler);
flowScheduler.add(reward_reval_realLoopEnd);
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'microphone.png', 'path': 'microphone.png'},
    ...
    {'name': 'thermometer.png', 'path': 'thermometer.png'},
    ...
    {'name': 'pr_learning_trials_0actions_easier_r2.csv', 'path': 'pr_learning_trials_0actions_easier_r2.csv'},
...
function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.co/submissions/complete?cc=763C1391', '');
...
var text_30;
var key_resp_16;
var reward_revaluation_choiceClock;
var im1_planning_4;
var im2_planning_4;
var example_trial_choice_phase_6;
var im1_rewvalue_planning_4;
var im2_rewvalue_planning_4;
var text_101;
var key_resp_33;
var reward_reval_choiceClock;
var text_96;
var trident_choice;
var planet_choice;
var key_resp_31;
...
function experimentInit() {
  ...
  planet_start_learning = new visual.ImageStim({
    win : psychoJS.window,
    name : 'planet_start_learning', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.4, 0], size : [0.25, 0.25],
    color : new util.Color([1, 1, 1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  text_3 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.25), (- 0.2)], height: 0.07,  wrapWidth: undefined, ori: 0.0,
    color: new util.Color('black'),  opacity: undefined,
    depth: -4.0 
  });
  ...
  trident_choice_2 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'trident_choice_2', units : undefined, 
    image : 'trident.png', mask : undefined,
    ori : 0.0, pos : [(- 0.3), 0], size : [0.25, 0.25],
    color : new util.Color([1, 1, 1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  planet_choice_2 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'planet_choice_2', units : undefined, 
    image : 'planet.png', mask : undefined,
    ori : 0.0, pos : [0.3, 0], size : [0.25, 0.25],
    color : new util.Color([1, 1, 1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  reward_revaluation_choiceClock = new util.Clock();
  im1_planning_4 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'im1_planning_4', units : undefined, 
    image : undefined, mask : undefined,
  ...
  im2_planning_4 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'im2_planning_4', units : undefined, 
    image : undefined, mask : undefined,
  ...
  example_trial_choice_phase_6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'example_trial_choice_phase_6',
    text: 'Reward information for upcoming trial:',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0.35], height: 0.05,  wrapWidth: undefined, ori: 0.0,
  ...
  im1_rewvalue_planning_4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'im1_rewvalue_planning_4',
    text: '',
    font: 'Open Sans',
    units: undefined, 
  ...
  im2_rewvalue_planning_4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'im2_rewvalue_planning_4',
    text: '',
    font: 'Open Sans',
    units: undefined, 
    pos: [0.2, (- 0.15)], height: 0.045,  wrapWidth: undefined, ori: 0.0,
  ...
  reward_reval_choiceClock = new util.Clock();
  ...
  trident_choice = new visual.ImageStim({
    win : psychoJS.window,
    name : 'trident_choice', units : undefined, 
    image : 'trident.png', mask : undefined,
    ori : 0.0, pos : [(- 0.3), 0], size : [0.25, 0.25],
    color : new util.Color([1, 1, 1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  planet_choice = new visual.ImageStim({
    win : psychoJS.window,
    name : 'planet_choice', units : undefined, 
    image : 'planet.png', mask : undefined,
    ori : 0.0, pos : [0.3, 0], size : [0.25, 0.25],
    color : new util.Color([1, 1, 1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  reward_reval_seeClock = new util.Clock();
  ...
  bell_reval = new visual.ImageStim({
    win : psychoJS.window,
    name : 'bell_reval', units : undefined, 
    image : 'bell.png', mask : undefined,
    ori : 0.0, pos : [0.2, (- 0.25)], size : [0.2, 0.2],
    color : new util.Color([1, 1, 1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
    texRes : 128.0, interpolate : true, depth : -8.0 
...
function trialsLoopBegin(trialsLoopScheduler) {
  ...
  trials = new TrialHandler({
    ...
    extraInfo: expInfo, originPath: undefined,
    trialList: 'pr_learning_trials_0actions_easier_r2.csv',
...
var PRG_vs_Guessing;
function PRG_vs_GuessingLoopBegin(PRG_vs_GuessingLoopScheduler) {
  // set up handler to look after randomisation of conditions etc
  PRG_vs_Guessing = new TrialHandler({
    psychoJS: psychoJS,
    nReps: 1, method: TrialHandler.Method.RANDOM,
    extraInfo: expInfo, originPath: undefined,
    trialList: 'new_choicephase.xlsx',
    seed: undefined, name: 'PRG_vs_Guessing'
  });
  psychoJS.experiment.addLoop(PRG_vs_Guessing); // add the loop to the experiment
  currentLoop = PRG_vs_Guessing;  // we're now the current loop

  // Schedule all the trials in the trialList:
  for (const thisPRG_vs_Guessing of PRG_vs_Guessing) {
    const snapshot = PRG_vs_Guessing.getSnapshot();
    PRG_vs_GuessingLoopScheduler.add(importConditions(snapshot));
    PRG_vs_GuessingLoopScheduler.add(info_choicephaseRoutineBegin(snapshot));
    PRG_vs_GuessingLoopScheduler.add(info_choicephaseRoutineEachFrame(snapshot));
    PRG_vs_GuessingLoopScheduler.add(info_choicephaseRoutineEnd(snapshot));
    PRG_vs_GuessingLoopScheduler.add(stage1_choice_enactRoutineBegin(snapshot));
    PRG_vs_GuessingLoopScheduler.add(stage1_choice_enactRoutineEachFrame(snapshot));
    PRG_vs_GuessingLoopScheduler.add(stage1_choice_enactRoutineEnd(snapshot));
    PRG_vs_GuessingLoopScheduler.add(final_stage5RoutineBegin(snapshot));
    PRG_vs_GuessingLoopScheduler.add(final_stage5RoutineEachFrame(snapshot));
    PRG_vs_GuessingLoopScheduler.add(final_stage5RoutineEnd(snapshot));
    PRG_vs_GuessingLoopScheduler.add(endLoopIteration(PRG_vs_GuessingLoopScheduler, snapshot));
  }
...
function PRG_vs_GuessingLoopEnd() {
  psychoJS.experiment.removeLoop(PRG_vs_Guessing);

  return Scheduler.Event.NEXT;
}


var reward_reval_real;
function reward_reval_realLoopBegin(reward_reval_realLoopScheduler) {
  // set up handler to look after randomisation of conditions etc
  reward_reval_real = new TrialHandler({
    psychoJS: psychoJS,
    nReps: 1, method: TrialHandler.Method.RANDOM,
    extraInfo: expInfo, originPath: undefined,
    trialList: 'choicephase_afterevaluation.xlsx',
    seed: undefined, name: 'reward_reval_real'
  });
  psychoJS.experiment.addLoop(reward_reval_real); // add the loop to the experiment
  currentLoop = reward_reval_real;  // we're now the current loop

  // Schedule all the trials in the trialList:
  for (const thisReward_reval_real of reward_reval_real) {
    const snapshot = reward_reval_real.getSnapshot();
    reward_reval_realLoopScheduler.add(importConditions(snapshot));
    reward_reval_realLoopScheduler.add(reward_revaluation_choiceRoutineBegin(snapshot));
    reward_reval_realLoopScheduler.add(reward_revaluation_choiceRoutineEachFrame(snapshot));
    reward_reval_realLoopScheduler.add(reward_revaluation_choiceRoutineEnd(snapshot));
    reward_reval_realLoopScheduler.add(reward_reval_choiceRoutineBegin(snapshot));
    reward_reval_realLoopScheduler.add(reward_reval_choiceRoutineEachFrame(snapshot));
    reward_reval_realLoopScheduler.add(reward_reval_choiceRoutineEnd(snapshot));
    reward_reval_realLoopScheduler.add(reward_reval_seeRoutineBegin(snapshot));
    reward_reval_realLoopScheduler.add(reward_reval_seeRoutineEachFrame(snapshot));
    reward_reval_realLoopScheduler.add(reward_reval_seeRoutineEnd(snapshot));
    reward_reval_realLoopScheduler.add(endLoopIteration(reward_reval_realLoopScheduler, snapshot));
  }
...
function reward_reval_realLoopEnd() {
  psychoJS.experiment.removeLoop(reward_reval_real);
...
function transition_revaluation_roundLoopBegin(transition_revaluation_roundLoopScheduler) {
  ...
  for (const thisTransition_revaluation_round of transition_revaluation_round) {
    ...
    transition_revaluation_roundLoopScheduler.add(stage1_choice_enactRoutineBegin(snapshot));
    transition_revaluation_roundLoopScheduler.add(stage1_choice_enactRoutineEachFrame(snapshot));
    transition_revaluation_roundLoopScheduler.add(stage1_choice_enactRoutineEnd(snapshot));
    transition_revaluation_roundLoopScheduler.add(final_stage5RoutineBegin(snapshot));
    transition_revaluation_roundLoopScheduler.add(final_stage5RoutineEachFrame(snapshot));
    transition_revaluation_roundLoopScheduler.add(final_stage5RoutineEnd(snapshot));
...
function stage1RoutineBegin(snapshot) {
  return function () {
    ...
    stage1Components.push(planet_start_learning);
...
function stage1RoutineEachFrame(snapshot) {
  return function () {
    ...
    if (t >= 0.35 && click_action.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    if (t >= 0.0 && planet_start_learning.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      planet_start_learning.tStart = t;  // (not accounting for frame time here)
...
function learning_trial_sequenceRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of learning_trial_sequenceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stage1_choice_enactRoutineBegin(snapshot) {
  return function () {
    ...
    stage1_choice_enactComponents.push(trident_choice_2);
    stage1_choice_enactComponents.push(planet_choice_2);
...
function stage1_choice_enactRoutineEachFrame(snapshot) {
  return function () {
    ...
    if (t >= 0.0 && trident_choice_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      trident_choice_2.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && planet_choice_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      planet_choice_2.tStart = t;  // (not accounting for frame time here)
...
var reward_revaluation_choiceComponents;
function reward_revaluation_choiceRoutineBegin(snapshot) {
  return function () {
    //------Prepare to start Routine 'reward_revaluation_choice'-------
    t = 0;
    reward_revaluation_choiceClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    ...
    // keep track of which components have finished
    reward_revaluation_choiceComponents = [];
    reward_revaluation_choiceComponents.push(im1_planning_4);
    reward_revaluation_choiceComponents.push(im2_planning_4);
    reward_revaluation_choiceComponents.push(example_trial_choice_phase_6);
    reward_revaluation_choiceComponents.push(im1_rewvalue_planning_4);
    reward_revaluation_choiceComponents.push(im2_rewvalue_planning_4);
    reward_revaluation_choiceComponents.push(text_101);
    reward_revaluation_choiceComponents.push(key_resp_33);
    
    for (const thisComponent of reward_revaluation_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function reward_revaluation_choiceRoutineEachFrame(snapshot) {
  return function () {
    //------Loop for each frame of Routine 'reward_revaluation_choice'-------
    // get current time
    ...
    if (t >= 0.0 && im1_planning_4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      im1_planning_4.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && im2_planning_4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      im2_planning_4.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && example_trial_choice_phase_6.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      example_trial_choice_phase_6.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && im1_rewvalue_planning_4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      im1_rewvalue_planning_4.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && im2_rewvalue_planning_4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      im2_rewvalue_planning_4.tStart = t;  // (not accounting for frame time here)
    ...
    // *text_101* updates
    if (t >= 2.0 && text_101.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    // *key_resp_33* updates
    if (t >= 2.0 && key_resp_33.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
...
function reward_revaluation_choiceRoutineEnd(snapshot) {
  return function () {
...
var reward_reval_choiceComponents;
function reward_reval_choiceRoutineBegin(snapshot) {
  return function () {
    //------Prepare to start Routine 'reward_reval_choice'-------
    t = 0;
    reward_reval_choiceClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    ...
    // keep track of which components have finished
    reward_reval_choiceComponents = [];
    reward_reval_choiceComponents.push(text_96);
    reward_reval_choiceComponents.push(trident_choice);
    reward_reval_choiceComponents.push(planet_choice);
    reward_reval_choiceComponents.push(key_resp_31);
    reward_reval_choiceComponents.push(text_97);
    reward_reval_choiceComponents.push(text_98);
    
    for (const thisComponent of reward_reval_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function reward_reval_choiceRoutineEachFrame(snapshot) {
  return function () {
    //------Loop for each frame of Routine 'reward_reval_choice'-------
    // get current time
    ...
    if (t >= 0.0 && trident_choice.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      trident_choice.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && planet_choice.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      planet_choice.tStart = t;  // (not accounting for frame time here)
    ...
    // *key_resp_31* updates
    if (t >= 0.2 && key_resp_31.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    if (key_resp_31.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_31.getKeys({keyList: ['1', '9'], waitRelease: false});
...
function reward_reval_choiceRoutineEnd(snapshot) {
  return function () {
...
var reward_reval_seeComponents;
function reward_reval_seeRoutineBegin(snapshot) {
  return function () {
    //------Prepare to start Routine 'reward_reval_see'-------
    t = 0;
    reward_reval_seeClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    ...
    // keep track of which components have finished
    reward_reval_seeComponents = [];
    reward_reval_seeComponents.push(text_99);
    reward_reval_seeComponents.push(text_100);
    reward_reval_seeComponents.push(key_resp_32);
    
    for (const thisComponent of reward_reval_seeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function reward_reval_seeRoutineEachFrame(snapshot) {
  return function () {
    //------Loop for each frame of Routine 'reward_reval_see'-------
    // get current time
    ...
    // *text_99* updates
    if (t >= 0 && text_99.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    // *text_100* updates
    if (t >= 1.6 && text_100.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    // *key_resp_32* updates
    if (t >= 1.75 && key_resp_32.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
...
function reward_reval_seeRoutineEnd(snapshot) {
  return function () {
...
function transition_revaluationRoutineBegin(snapshot) {
  return function () {
    ...
    transition_revaluationComponents.push(bell_reval);
...
function transition_revaluationRoutineEachFrame(snapshot) {
  return function () {
    ...
    // *bell_reval* updates
    if (t >= 0.0 && bell_reval.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      bell_reval.tStart = t;  // (not accounting for frame time here)
