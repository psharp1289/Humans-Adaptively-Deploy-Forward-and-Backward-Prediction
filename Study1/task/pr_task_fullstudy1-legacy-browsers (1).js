...
function PRG_vs_GuessingLoopBegin(PRG_vs_GuessingLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  PRG_vs_Guessing.forEach(function() {
...
function reward_reval_realLoopBegin(reward_reval_realLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  reward_reval_real.forEach(function() {
...
function reward_revaluation_choiceRoutineBegin(snapshot) {
  return function () {
    ...
    reward_revaluation_choiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function reward_reval_choiceRoutineBegin(snapshot) {
  return function () {
    ...
    reward_reval_choiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function reward_reval_seeRoutineBegin(snapshot) {
  return function () {
    ...
    reward_reval_seeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
