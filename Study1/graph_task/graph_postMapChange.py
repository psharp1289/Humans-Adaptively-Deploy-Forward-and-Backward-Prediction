...
icon_positions = {
    ...
    'train': (0.10, 0.3, 0.1, 0.1),
    'houses': (0.30, 0.3, 0.1, 0.1),
    'compass': (0.50, 0.3, 0.1, 0.1),
    'thermometer': (0.70, 0.3, 0.1, 0.1),
    'microphone': (0.90, 0.3, 0.1, 0.1),
    'north': (1.10, 0.3, 0.1, 0.1),
    'snorkel': (1.30, 0.3, 0.1, 0.1),
    'tophat': (1.50, 0.3, 0.1, 0.1),
}
...
# Create the legend
# plt.legend(handles=legend_handles, loc='upper center', ncol=len(transitions))

# Set the title of the plot
plt.title('State Space Study 1 After Map Change')
plt.tight_layout()

plt.savefig('State Space 1 After Map', dpi=300)
# Show the plot
plt.show()
