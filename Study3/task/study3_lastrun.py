...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/paul/Documents_local/PR_project/Study3/task/study3_lastrun.py',
...
choice_transistion_revalClock = core.Clock()
...
final_stage_TrClock = core.Clock()
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
time_limitClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=time_limitClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Study3_learningtrials.csv'),
...
for thisTrial in trials:
    ...
    for thisAction_selection in action_selection:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if click_action.status == STARTED:
                ...
                if tThisFlipGlobal > click_action.tStartRefresh + 6.8-frameTolerance:
                    ...
                    win.timeOnFlip(click_action, 'tStopRefresh')  # time at next scr refresh
            ...
            if picture_image.status == STARTED:
                ...
                if tThisFlipGlobal > picture_image.tStartRefresh + 7-frameTolerance:
                    ...
                    win.timeOnFlip(picture_image, 'tStopRefresh')  # time at next scr refresh
        ...
        action_selection.addData('picture_image.started', picture_image.tStartRefresh)
        action_selection.addData('picture_image.stopped', picture_image.tStopRefresh)
    ...
    trials.addData('memory_image1.started', memory_image1.tStartRefresh)
    trials.addData('memory_image1.stopped', memory_image1.tStopRefresh)
    trials.addData('memory_image2.started', memory_image2.tStartRefresh)
    trials.addData('memory_image2.stopped', memory_image2.tStopRefresh)
...
for thisPR_vs_SR in PR_vs_SR:
    ...
    for thisComponent in info_choicephaseComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    PR_vs_SR.addData('im1_planning.started', im1_planning.tStartRefresh)
    PR_vs_SR.addData('im1_planning.stopped', im1_planning.tStopRefresh)
    PR_vs_SR.addData('im2_planning.started', im2_planning.tStartRefresh)
    PR_vs_SR.addData('im2_planning.stopped', im2_planning.tStopRefresh)
    PR_vs_SR.addData('example_trial_choice_phase_2.started', example_trial_choice_phase_2.tStartRefresh)
    PR_vs_SR.addData('example_trial_choice_phase_2.stopped', example_trial_choice_phase_2.tStopRefresh)
    PR_vs_SR.addData('im1_rewvalue_planning.started', im1_rewvalue_planning.tStartRefresh)
    PR_vs_SR.addData('im1_rewvalue_planning.stopped', im1_rewvalue_planning.tStopRefresh)
    PR_vs_SR.addData('im2_rewvalue_planning.started', im2_rewvalue_planning.tStartRefresh)
    PR_vs_SR.addData('im2_rewvalue_planning.stopped', im2_rewvalue_planning.tStopRefresh)
    PR_vs_SR.addData('text_29.started', text_29.tStartRefresh)
    PR_vs_SR.addData('text_29.stopped', text_29.tStopRefresh)
    # check responses
    ...
    PR_vs_SR.addData('key_resp_24.started', key_resp_24.tStartRefresh)
    PR_vs_SR.addData('key_resp_24.stopped', key_resp_24.tStopRefresh)
    PR_vs_SR.addData('goal_image.started', goal_image.tStartRefresh)
    PR_vs_SR.addData('goal_image.stopped', goal_image.tStopRefresh)
    PR_vs_SR.addData('im3_num_planning.started', im3_num_planning.tStartRefresh)
    PR_vs_SR.addData('im3_num_planning.stopped', im3_num_planning.tStopRefresh)
    ...
    for thisComponent in stage1_choice_enactComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    PR_vs_SR.addData('text_81.started', text_81.tStartRefresh)
    PR_vs_SR.addData('text_81.stopped', text_81.tStopRefresh)
    PR_vs_SR.addData('image1test.started', image1test.tStartRefresh)
    PR_vs_SR.addData('image1test.stopped', image1test.tStopRefresh)
    PR_vs_SR.addData('image2test.started', image2test.tStartRefresh)
    PR_vs_SR.addData('image2test.stopped', image2test.tStopRefresh)
    # check responses
    ...
    PR_vs_SR.addData('key_resp_25.started', key_resp_25.tStartRefresh)
    PR_vs_SR.addData('key_resp_25.stopped', key_resp_25.tStopRefresh)
    PR_vs_SR.addData('text_31.started', text_31.tStartRefresh)
    PR_vs_SR.addData('text_31.stopped', text_31.tStopRefresh)
    PR_vs_SR.addData('text_82.started', text_82.tStartRefresh)
    PR_vs_SR.addData('text_82.stopped', text_82.tStopRefresh)
    ...
    for thisComponent in final_stage5Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    PR_vs_SR.addData('text_68.started', text_68.tStartRefresh)
    PR_vs_SR.addData('text_68.stopped', text_68.tStopRefresh)
    PR_vs_SR.addData('text_30.started', text_30.tStartRefresh)
    PR_vs_SR.addData('text_30.stopped', text_30.tStopRefresh)
...
thisExp.nextEntry()
thisExp.addData('tree_reval.started', tree_reval.tStartRefresh)
thisExp.addData('tree_reval.stopped', tree_reval.tStopRefresh)
...
for thisTransition_revaluation_round in transition_revaluation_round:
    ...
    transition_revaluation_round.addData('goal_transition_reval.started', goal_transition_reval.tStartRefresh)
    transition_revaluation_round.addData('goal_transition_reval.stopped', goal_transition_reval.tStopRefresh)
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    choice_transistion_revalClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=choice_transistion_revalClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if transition_reval_choice.status == STARTED and not waitOnFlip:
            theseKeys = transition_reval_choice.getKeys(keyList=['1', '9'], waitRelease=False)
    ...
    for thisComponent in choice_transistion_revalComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    transition_revaluation_round.addData('text_105.started', text_105.tStartRefresh)
    transition_revaluation_round.addData('text_105.stopped', text_105.tStopRefresh)
    transition_revaluation_round.addData('trident_choice_3.started', trident_choice_3.tStartRefresh)
    transition_revaluation_round.addData('trident_choice_3.stopped', trident_choice_3.tStopRefresh)
    transition_revaluation_round.addData('planet_choice_3.started', planet_choice_3.tStartRefresh)
    transition_revaluation_round.addData('planet_choice_3.stopped', planet_choice_3.tStopRefresh)
    # check responses
    ...
    transition_revaluation_round.addData('transition_reval_choice.started', transition_reval_choice.tStartRefresh)
    transition_revaluation_round.addData('transition_reval_choice.stopped', transition_reval_choice.tStopRefresh)
    transition_revaluation_round.addData('text_106.started', text_106.tStartRefresh)
    transition_revaluation_round.addData('text_106.stopped', text_106.tStopRefresh)
    transition_revaluation_round.addData('text_107.started', text_107.tStartRefresh)
    transition_revaluation_round.addData('text_107.stopped', text_107.tStopRefresh)
    ...
    # keep track of which components have finished
    final_stage_TrComponents = [text_103, text_104, key_resp_34]
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    final_stage_TrClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=final_stage_TrClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if text_103.status == STARTED:
            ...
            if tThisFlipGlobal > text_103.tStartRefresh + 1.5-frameTolerance:
                ...
                win.timeOnFlip(text_103, 'tStopRefresh')  # time at next scr refresh
        ...
        # *key_resp_34* updates
        waitOnFlip = False
        if key_resp_34.status == NOT_STARTED and tThisFlip >= 1.75-frameTolerance:
            # keep track of start time/frame for later
    ...
    for thisComponent in final_stage_TrComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    transition_revaluation_round.addData('text_103.started', text_103.tStartRefresh)
    transition_revaluation_round.addData('text_103.stopped', text_103.tStopRefresh)
    transition_revaluation_round.addData('text_104.started', text_104.tStartRefresh)
    transition_revaluation_round.addData('text_104.stopped', text_104.tStopRefresh)
