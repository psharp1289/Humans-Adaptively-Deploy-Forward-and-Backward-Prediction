...
'bell':'end','tree':8,'watch':9,'fox':10,
    
'train':1,'tophat':2,'north':3,'snorkel':4,'compass':5,'hammer':6,'apple':7,
...
# ax.set_xlim([0.3, 1.80])
# ax.set_ylim([0.2, 1])

# # Define the position and size of each icon
# icon_positions = {
#     'trident': (1.2, 0.3, 0.1, 0.1),
#     'planet': (0.8, 0.3, 0.1, 0.1),
#     'bell': (1, 0.3, 0.1, 0.1),
#     'tree': (0.8, 0.5, 0.1, 0.1),
#     'watch': (1, 0.5, 0.1, 0.1),
#     'fox': (1.2, 0.5, 0.1, 0.1),
    
    
#     'north': (0.4, 0.8, 0.1, 0.1),
#     'snorkel': (0.6, 0.8, 0.1, 0.1),
#     'train': (0.8, 0.8, 0.1, 0.1),
#     'tophat': (1, 0.8, 0.1, 0.1),
#     'compass': (1.2, 0.8, 0.1, 0.1),
#     'hammer': (1.4, 0.8, 0.1, 0.1),
#     'apple': (1.6, 0.8, 0.1, 0.1),
# }
...
# base_rate_handles = [mpatches.Patch(color='none', label='          p=0.11                            p = 0.38                     p = 0.09'),
#                      ]
...
#            loc='upper center',
#            bbox_to_anchor=(0.52, 1.01),  # Adjust these values as needed
#            title="    Base Rates",
#            ncol=2,
...
#     ax.plot([1.15, 1.2],[0.90, 0.84],color='black',linewidth=1,linestyle='-',zorder=8)
#     ax.plot([0.7, 0.4],[0.90, 0.845],color='black',linewidth=1,linestyle='-',zorder=8)
#     ax.plot([0.7, 0.6],[0.90, 0.845],color='black',linewidth=1,linestyle='-',zorder=8)
#     ax.plot([0.7, 0.8],[0.90, 0.845],color='black',linewidth=1,linestyle='-',zorder=8)
#     ax.plot([0.7, 1.0],[0.90, 0.845],color='black',linewidth=1,linestyle='-',zorder=8)
#     ax.plot([1.5, 1.4],[0.90, 0.845],color='black',linewidth=1,linestyle='-',zorder=8)
#     ax.plot([1.5, 1.6],[0.90, 0.845],color='black',linewidth=1,linestyle='-',zorder=8)
...
transitions=[ #choice 1
             ...
             #transition stage 2
             ['bell']*205+['planet']*205,
             ['bell']*295+['trident']*295,
             ['trident']*40+['trident']*40,
             ]
...
legend = plt.legend(handles=base_rate_handles,
           loc='upper center',
           bbox_to_anchor=(0.5, 1.01),  # Adjust these values as needed
           title="Base Rates\n",
           ncol=2,
           handlelength=0,  # Hide the patch
           handletextpad=0,  # Remove space between the patch and the text
...
for text in legend.get_texts():
    ...
    # Draw an arrow from the title to each entry
    ax.plot([0.68, 0.93],[0.92, 0.98],color='black',linewidth=1,linestyle='-',zorder=8)
    ax.plot([1.50, 1.18],[0.92, 0.98],color='black',linewidth=1,linestyle='-',zorder=8)
    ax.plot([1.18, 1.1],[0.92, 0.96],color='black',linewidth=1,linestyle='-',zorder=8)
    draw_bracket(ax, 0.38, 1.04, 0.86)
    draw_bracket(ax, 1.64, 1.37, 0.86)
    draw_bracket(ax, 1.16, 1.24, 0.86)
